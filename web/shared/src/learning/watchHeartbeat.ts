...
interface PlaybackLifecycleOptions {
  ...
  sessionIDFactory?: ReportIDFactory;
}
...
export class WatchHeartbeat {
  ...
  private readonly reportIDFactory: ReportIDFactory;

  constructor(
    reportIDFactory: ReportIDFactory = defaultReportIDFactory,
    sessionIDFactory: ReportIDFactory = defaultReportIDFactory,
  ) {
    this.reportIDFactory = reportIDFactory;
...
export class PlaybackLifecycleController {
  ...
  private readonly options: PlaybackLifecycleOptions;

  constructor(options: PlaybackLifecycleOptions) {
    this.options = options;
    this.heartbeat = new WatchHeartbeat(options.reportIDFactory, options.sessionIDFactory);
  }
