...
import { Button, Card, Form, Modal, Popconfirm, Select, Table, Tag } from 'antd'
import type { CourseEnrollment } from '../../api/course'
    ...
    <Card className="course-enrollment-manager" title="学员分配" extra={
      ...
      <Table<CourseEnrollment>
        ...
        columns={[
          ...
          { title: '课程类型', render: () => <Tag color={controller.course?.course_type === 'required' ? 'magenta' : 'blue'}>{controller.course?.course_type === 'required' ? '必修课' : '选修课'}</Tag> },
